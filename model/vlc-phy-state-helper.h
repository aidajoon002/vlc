 ...
 */
class VlcPhyStateHelper : public Object
{
public:
   ...
   * \param callback
   */
  void SetReceiveOkCallback (VlcPhy::RxOkCallback callback);
  /**
   * Set a callback for a failed reception.
   *
   * \param callback
   */
  void SetReceiveErrorCallback (VlcPhy::RxErrorCallback callback);
  /**
   ...
   * \return the current state of WifiPhy
   */
  enum VlcPhy::State GetState (void);
  /**
   ...
   */
  void SwitchToTx (Time txDuration_vlc, Ptr<const Packet> packet_vlc, WifiMode txMode_vlc, WifiPreamble preamble_vlc, uint8_t txPower_vlc);
  /**
   * Switch state to RX for the given duration.
   *
   * \param rxDuration the duration of the RX
   */
  void SwitchToRx (Time rxDuration_vlc);
  /**
   ...
   */
  void SwitchFromRxEndOk (Ptr<Packet> packet_vlc, double snr, WifiMode mode_vlc, enum WifiPreamble preamble_vlc);
  /**
   ...
   * \param snr the SNR of the received packet
   */
  void SwitchFromRxEndError (Ptr<const Packet> packet_vlc, double snr_vlc);
  /**
   * Switch to CCA busy.
   *
  ...
  TracedCallback<Time,Time,enum VlcPhy::State> m_stateLogger;
private:
  /**
  ...
  VlcPhy::RxOkCallback m_rxOkCallback;
  VlcPhy::RxErrorCallback m_rxErrorCallback;
};
