 ...
 */
class ApVlcMac : public RegularWifiMac
{
public:
   ...
   */
  virtual void Enqueue (Ptr<const Packet> packet_vlc, Mac48Address to);
   ...
   */
  virtual void Enqueue (Ptr<const Packet> packet_vlc, Mac48Address to, Mac48Address from);
...
private:
  virtual void Receive (Ptr<Packet> packet_vlc, const WifiMacHeader *hdr);
  /**
   ...
   */
  void ForwardDown (Ptr<const Packet> packet_vlc, Mac48Address from, Mac48Address to);
  /**
   ...
   */
  void ForwardDown (Ptr<const Packet> packet_vlc, Mac48Address from, Mac48Address to, uint8_t tid);
  /**
